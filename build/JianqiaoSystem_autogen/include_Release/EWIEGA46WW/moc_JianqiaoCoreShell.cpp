...
static constexpr auto qt_meta_stringdata_ZN17JianqiaoCoreShellE = QtMocHelpers::stringData(
    "JianqiaoCoreShell"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN17JianqiaoCoreShellE[] = {
...
Q_CONSTINIT const QMetaObject JianqiaoCoreShell::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN17JianqiaoCoreShellE.offsetsAndSizes,
    qt_meta_data_ZN17JianqiaoCoreShellE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN17JianqiaoCoreShellE_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<JianqiaoCoreShell, std::true_type>
    >,
    nullptr
} };
...
void *JianqiaoCoreShell::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN17JianqiaoCoreShellE.stringdata0))
